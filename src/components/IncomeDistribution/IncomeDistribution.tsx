    ...
    <section className={styles.sectionWrapper}>
      <Container maxW="8xl" className={styles.wrapper}>
        ...
        <div className={styles.distributionColumns}>
          <div>
            <p className={styles.title}>concursuri intre 7 si 30 zile</p>
            ...
            <div className={styles.stepWrapper}>
              ...
              <p className={styles.stepDescription}>
                2% din suma stransa merge catre un fond special de caritate ca va fi gestionat prin
                vot de catre detinatorii de NFTs indiferent de generatie
              </p>
              <p className={styles.stepPercentage}>
          ...
          <div>
            <p className={styles.title}>concursuri ce depasesc 30 zile</p>
            <div className={styles.stepWrapper}>
              <p className={styles.step}>step 1</p>
              <p className={styles.stepDescription}>
                <span>$1.000.000</span>
            ...
            <div className={styles.stepWrapper}>
              <p className={styles.step}>step 2</p>
              <p className={styles.stepDescription}>
                Daca suma sa depasit , 20% din suma care depaseste valoarea de validare se imparte
                intre 3 castigatori intr-o noua extragere
              </p>
              <p className={styles.stepPercentage}>
            ...
            <div className={styles.stepWrapper}>
              ...
              <p className={styles.stepPercentage}>
                <span className={`${styles.percentage} ${styles.percentageThirtyFive}`}>35%</span>
              </p>
            </div>
            ...
            <div className={styles.stepWrapper}>
              <p className={styles.step}>charity</p>
              <p className={styles.stepDescription}>
                10% din suma stransa merge catre un fond special de caritate ca va fi gestionat prin
                vot de catre detinatorii de NFTs indiferent de generatie
              </p>
              <p className={styles.stepPercentage}>
