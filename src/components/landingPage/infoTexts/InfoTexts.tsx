          ...
          >
            <section style={{ width: '100%' }}>
              ...
              >
                ...
                income with our community through the Baffle Space Affiliate Program.
                <br />
                <br />
      ...
      >
        <Box width={{ base: 'auto', md: '50%' }}>
          ...
          <Text color="#fff" fontSize="16px">
            ...
            their affiliate links. These types of earnings of NFT owners will further be called
            &lsquo;UniWhale Earnings&rsquo; throughout the Baffle Space Ecosystem.
            <br />
            <br />
