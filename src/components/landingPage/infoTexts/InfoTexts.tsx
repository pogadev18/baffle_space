    ...
    >
      ...
      >
        <Box textAlign="center">
          ...
          >
            The earning system is designed with a community first approach in mind. As opposed to
            conventional games of chance, we decided to distribute the majority of the games’ income
            with our community through the Baffle Space Affiliate Program.
            <br />
            <br />
            Have your Baffle Space Genesis NFT as soon as they launch and it will grant you the
            power to earn up to 99ETH by the time they get sold out.
            <br />
            <br />
            When Baffle Space Games start a whopping 60% of the income generated by each game will
            be distributed among NFT owners engaged in the game.
            <br />
            <br />
            You can simulate your earnings from NFT and ticket sales for the games.
          </Text>
        ...
        <Box marginTop={{ base: '0px', '2xl': '60px' }} color="#fff">
          <SimulateEarnings />
        </Box>
      </Box>
